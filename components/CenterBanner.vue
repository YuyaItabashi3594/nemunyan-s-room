<template>
  <div class="centerbanner bg-gray-700 mx-auto mt-10 rounded-xl py-2 px-6">
    ...
    <div class="flex flex-row items-start justify-center mt-4">
      <a href="https://github.com/YuyaItabashi3594"><font-awesome-icon :icon="['fab', 'github']" class="mr-2 text-white" /></a>
      <a href=""><font-awesome-icon :icon="['fab', 'discord']" class="mr-2 text-white" /></a>
    </div>
  </div>
</template>
